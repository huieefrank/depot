...
describe OrdersController do
  ...
  describe "GET index" do
    it "assigns all orders as @orders" do
      Order.stub(:find).with(:all).and_return([mock_order])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested order as @order" do
      Order.stub(:find).with("37").and_return(mock_order)
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new order as @order" do
      Order.stub(:new).and_return(mock_order)
      get :new
      assigns[:order].should equal(mock_order)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created order as @order" do
        Order.stub(:new).with({'these' => 'params'}).and_return(mock_order(:save => true))
